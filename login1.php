...
function item_masonry(){ 
	$('.item img').load(function(){ 
		$('.infinite_scroll').masonry({ 
			...
			columnWidth:226,     // 网格宽度 
			gutterWidth:15		// 图片之间宽度					
		});		
	});
...
$(function(){
	...
	function item_callback(){ 
		...
		$('.item').mouseover(function(){             // 鼠标位于图边上 显示加入专辑
...
<div class="demo clearfix">
	...
	<div class="item_list infinite_scroll">
		...
		<div class="item masonry_brick">
			<div class="item_t">
				<div class="img">
					<a href="http://www.jsfoot.com/js/images/more/2012-05-15/608.html"><img width="210" height="285" alt="js lazyload实现网页图片延迟加载特效" src="images/pic/01.jpg" /></a>
		...
		<div class="item masonry_brick">
			<div class="item_t">
				<div class="img">
					<a href="http://www.jsfoot.com/js/images/cj/2012-03-14/420.html"><img width="210" height="164" alt="js图片特效制作js焦点图上下滚动slider切换效果" src="images/pic/02.jpg" /></a>
					<span class="price">￥195.00</span>
					<div class="btns">
		...
		<div class="item masonry_brick">
			<div class="item_t">
				<div class="img">
					<a href="http://www.jsfoot.com/js/menu/sx/2012-03-25/502.html"><img width="210" height="287" alt="js树形导航菜单制作垂直js导航条特效" src="images/pic/03.jpg" /></a>
					<span class="price">￥195.00</span>
					<div class="btns">
		...
		<div class="item masonry_brick">
			<div class="item_t">
				<div class="img">
					<a href="http://www.jsfoot.com/flash/images/2012-09-06/753.html"><img width="210" height="285" alt="flash图片导航条自动切换轮播焦点图" src="images/pic/04.jpg" /></a>
					<span class="price">￥195.00</span>
					<div class="btns">
		...
		<div class="item masonry_brick">
			<div class="item_t">
				<div class="img">
					<a href="http://www.jsfoot.com/flash/images/2012-06-04/640.html"><img width="210" height="323" alt="flash图片特效左右按钮控制图片折叠切换效果" src="images/pic/05.jpg" /></a>
					<span class="price">￥195.00</span>
					<div class="btns">
		...
		<div class="item masonry_brick">
			<div class="item_t">
				<div class="img">
					<a href="http://www.jsfoot.com/flash/images/2012-05-08/596.html"><img width="210" height="315" alt="flash焦点图片带内容与按钮的3D动画图片特效" src="images/pic/06.jpg" /></a>
					<span class="price">￥195.00</span>
					<div class="btns">
		...
		<div class="item masonry_brick">
			<div class="item_t">
				<div class="img">
					<a href="http://www.jsfoot.com/flash/images/2012-03-11/388.html"><img width="210" height="282" alt="flash特效制作flash图片滚动带按钮控制左右图片滚动" src="images/pic/07.jpg" /></a>
					<span class="price">￥195.00</span>
					<div class="btns">
		...
		<div class="item masonry_brick">
			<div class="item_t">
				<div class="img">
					<a href="http://www.jsfoot.com/flash/images/2012-03-03/378.html"><img width="210" height="266" alt="flash焦点图切换特效制作各大网站的焦点图片轮播" src="images/pic/08.jpg" /></a>
					<span class="price">￥195.00</span>
					<div class="btns">
		...
		<div class="item masonry_brick">
			<div class="item_t">
				<div class="img">
					<a href="http://www.jsfoot.com/flash/images/2012-03-03/374.html"><img width="210" height="254" alt="flash焦点图切换动画图片和标题文字配合显示含flash源码下载" src="images/pic/09.jpg" /></a>
					<span class="price">￥195.00</span>
					<div class="btns">
		...
		<div class="item masonry_brick">
			<div class="item_t">
				<div class="img">
					<a href="http://www.jsfoot.com/flash/images/2012-03-03/370.html"><img width="210" height="276" alt="flash图片切换左右滚动带序列索引按钮控制flash动画图片特效" src="images/pic/10.jpg" /></a>
					<span class="price">￥195.00</span>
					<div class="btns">
		...
		<div class="item masonry_brick">
			<div class="item_t">
				<div class="img">
					<a href="http://www.jsfoot.com/flash/letter/2012-03-04/386.html"><img width="210" height="131" alt="flash文字特效制作数字类似文字打印效果,属于flash动画文字特效一种" src="images/pic/11.jpg" /></a>
					<span class="price">￥195.00</span>
					<div class="btns">
		...
		<div class="item masonry_brick">
			<div class="item_t">
				<div class="img">
					<a href="http://www.jsfoot.com/css3/layout/2011-10-13/215.html"><img width="210" height="131" alt="div+css制作在IE6 上用absolute模拟fixed IE6浏览器定位层框不闪动" src="images/pic/12.jpg" /></a>
					<span class="price">￥195.00</span>
					<div class="btns">
		...
		<div class="item masonry_brick">
			<div class="item_t">
				<div class="img">
					<a href="http://www.jsfoot.com/css3/layout/2011-02-21/36.html"><img width="210" height="287" alt="CSS如何定位工程" src="images/pic/13.jpg" /></a>
					<span class="price">￥195.00</span>
					<div class="btns">
		...
		<div class="item masonry_brick">
			<div class="item_t">
				<div class="img">
					<a href="http://www.jsfoot.com/css3/menu/2011-09-21/197.html"><img width="210" height="323" alt="用div+css3美化制作动画导航特效鼠标滑过动画显示" src="images/pic/14.jpg" /></a>
					<span class="price">￥195.00</span>
					<div class="btns">
		...
		<div class="item masonry_brick">
			<div class="item_t">
				<div class="img">
					<a href="http://www.jsfoot.com/css3/menu/2011-02-20/22.html"><img width="210" height="304" alt="用div+css制作一个CSS3的简约图标导航菜单" src="images/pic/15.jpg" /></a>
					<span class="price">￥195.00</span>
					<div class="btns">
		...
		<div class="item masonry_brick">
			<div class="item_t">
				<div class="img">
					<a href="http://www.jsfoot.com/html5/tx/2011-08-13/120.html"><img width="210" height="315" alt="jquery 图片特效用CSS3和HTML5制作仿动画头条报纸缩小到放大翻转图片展示" src="images/pic/16.jpg" /></a>
					<span class="price">￥195.00</span>
					<div class="btns">
		...
		<div class="item masonry_brick">
			<div class="item_t">
				<div class="img">
					<a href="http://www.jsfoot.com/html5/tx/2011-02-21/42.html"><img width="210" height="314" alt="jquery 幻灯片切换应用一个HTML5的幻灯片" src="images/pic/17.jpg" /></a>
					<span class="price">￥195.00</span>
					<div class="btns">
